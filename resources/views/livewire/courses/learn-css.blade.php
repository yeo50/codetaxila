<div>
    <div class="flex max-lg:flex-col mt-3 p-4 gap-2">
        ...
        <div class="space-y-3 flex-[3] max-lg:ps-4">
            ...
            <h1 class="text-violet-900 text-5xl  font-bold tracking-wide ">Learn CSS</h1>
            <p class="text-lg">In this CSS tutorial, you’ll learn how to add CSS to visually transform HTML into
                eye-catching sites.</p>
            ...
            <div class="flex items-center justify-between  max-lg:hidden">
                <a href="{{ route('learnCssTopic') }}" class="w-2/5"> <x-primary-button
                        class="w-full flex justify-center">Start
                    </x-primary-button></a>
                <div> 180 learners enrolled</div>
            </div>
        </div>
    ...
    <div class="flex flex-wrap max-md:flex-col space-y-2 justify-between gap-3 mt-4">
        <div class="flex-1 px-4">
            ...
            <p>You’ll find learning CSS essential in styling websites. Web developers use it to build on basic HTML and
                add personality to plain text pages. This course helps you expand your coding foundation and gives you
                CSS interactive practice to start adding colors and background images or editing layouts so you can
                create your very own, unique stylized web pages.
            </p>
        </div>
        <div class="flex-1 ps-4">
            ...
            <ul class="space-y-2">
                ...
                <li><span
                        class="me-1 text-white text-sm bg-black rounded-full w-5 h-5 inline-flex items-center justify-center">&#10003;</span>
                    Connect HTML and CSS files</li>
                <li><span
                        class="me-1 text-white text-sm bg-black rounded-full w-5 h-5 inline-flex items-center justify-center">&#10003;</span>
                    Create unique web page layouts</li>
            </ul>
        </div>
    </div>
</div>
