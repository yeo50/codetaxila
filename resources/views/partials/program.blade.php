   <section class="bg-[#67D2E0]">
        <h1 class="text-5xl font-bold text-center pt-10 mb-6 text-white">Programs & Enrollment</h1>
        <div>
            <div class="py-4 mb-4">
                <h2 class="text-2xl font-bold ps-8">
                    what we offer
                </h2>
                <p class="ps-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 pb-4 px-4">

                <div class="flex">
                    <div class=" p-9 bg-[#EEEDED]">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-20 h-20" version="1.1"
                ...
                <div class="flex">
                    <div class="p-9 bg-[#EEEDED]">
                        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" class="w-20 h-20"
                ...
                <div class="flex ">
                    <div class="p-9 bg-[#EEEDED]">
                        <svg class="w-20 h-20" viewBox="0 0 44 60" width="512" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="flex">
                    <div class="p-9 bg-[#EEEDED]">
                        <svg class="w-20 h-20" viewBox="-24 0 496 496" width="496pt"
